...
class login(QDialog):
    ...
    def __init__(self,app):
        ...
        self.formGroupBox.setStyleSheet("QGroupBox {background-image: url(background/background.jpg)}")
        self.success = False
        print("Login Screen")
        self.exec()
    ...
    def makeform(self):
        ...
        self.combo_label_person.addItem("Employee")
        self.combo_label_person.addItem("Administrator")
    ...
    def check_password(self):
        ...
        if (self.line_edit_username.text() == self.username_info) and (self.line_edit_password.text() == self.password_info):
            ...
            msg.setText('Check Username and Password')
            msg.exec_()
            user_type= None
            result = False
