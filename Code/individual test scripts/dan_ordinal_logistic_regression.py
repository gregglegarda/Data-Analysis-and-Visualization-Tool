...
min_max_scaler = preprocessing.MinMaxScaler() # ordinal logistic regression requires us to standardize/normalize the data. https://www.codespeedy.com/normalize-a-pandas-dataframe-column/; https://medium.com/evangelinelee/ordinal-logistic-regression-on-world-happiness-report-221372709095 
x_scaled = min_max_scaler.fit_transform(X)
normalized_dataframe = pd.DataFrame(x_scaled,columns=merged_features.columns)
normalized_dataframe

##################

X_train2, X_test2, y_train2, y_test2 = train_test_split(normalized_dataframe, y, test_size=0.3, random_state=1)

# instantiate models
model_ordinal = mord.LogisticAT(max_iter=100,verbose=3) # http://rikunert.com/ordinal_rating
